               ...
               <div class="col-xl-3 col-lg-3 col-md-3 col-sm-3 col logo_section">
                  <div class="full">
                     <div class="center-desk">
                        <div class="logo"> <a href="landing_page.php"><img src="./icon/logo.png" style=" height: 100px;
                                 width: 200px ; " ></a> </div>
                     </div>
                  </div>
               </div>
         ...
         <div class="card">
            <div class="signup-form">
               <center>
                  ...
                  <img src="jpg.jfif" alt="" height="75px" style="border-radius: 50%; height: 100px;">
               </center>
               <h1> Signup Form </h1>
               <div class="txt">
               ...
               <br>
               <a href="login.php">
                  <h4 style="margin-left:40px ; color: white;"> Already have an Account</h4>
               </a>
